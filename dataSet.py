# -*- coding: utf-8 -*-
"""
Created on Fri Feb 21 21:07:59 2020
...
class DataSet(object):
   ...
   def extract_data(self,path):
        ...
        #重新格式化和标准化
        X_train = X_train.reshape(X_train.shape[0], self.img_size, self.img_size,1)/255.0 #将x_train.shape[0]（垂直尺寸）调整，变成128*128*1再除以255.0
